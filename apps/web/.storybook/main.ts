...
const config: StorybookConfig = {
  ...
  // Performance: Enable lazy compilation for faster dev startup
  core: {
  ...
  webpackFinal: async (config) => {
    ...
    // Performance: Enable filesystem caching
    config.cache = {
      type: 'filesystem',
      buildDependencies: {
        config: [__filename],
    ...
    // Performance: Enable lazy compilation in development
  ...
  typescript: {
    // Performance: Use faster react-docgen instead of react-docgen-typescript
    // This significantly speeds up Storybook startup (react-docgen-typescript is slow)
