...
| `NEXT_PUBLIC_DATADOG_CLIENT_TOKEN`            | [Datadog](https://www.datadoghq.com) client token for logging and RUM                                                                                                                         |
| `NEXT_PUBLIC_DATADOG_APPLICATION_ID`          | Datadog RUM application ID for Real User Monitoring (must be from same app as client token)                                                                                                   |
| `NEXT_PUBLIC_DATADOG_SERVICE`                 | Datadog service name (defaults to app name)                                                                                                                                                   |
