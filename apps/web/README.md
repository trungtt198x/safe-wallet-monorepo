...
| `NEXT_PUBLIC_PROD_HYPERNATIVE_ALLOWLIST_OUTREACH_ID`    | Hypernative allowlist outreach ID (login CTA) for production                                                                                                                                                                                |
| `NEXT_PUBLIC_STAGING_HYPERNATIVE_ALLOWLIST_OUTREACH_ID` | Hypernative allowlist outreach ID (login CTA) for staging                                                                                                                                                                                   |
...
| `NEXT_PUBLIC_TURNSTILE_SITE_KEY`                        | [Cloudflare Turnstile](https://developers.cloudflare.com/turnstile/) site key for CAPTCHA protection                                                                                                                                        |
| `NEXT_PUBLIC_TURNSTILE_TEST_SITE_KEY`                   | (Optional) Test site key for development. Overrides `NEXT_PUBLIC_TURNSTILE_SITE_KEY` if set. Use test keys like `3x00000000000000000000FF` to force interactive challenges. See [Turnstile testing docs](https://developers.cloudflare.com/ |
