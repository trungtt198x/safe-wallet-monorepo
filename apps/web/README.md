...
| `NEXT_PUBLIC_DATADOG_CLIENT_TOKEN`            | [Datadog](https://www.datadoghq.com) client token for logging                                                                                                                                 |
| `NEXT_PUBLIC_DATADOG_APPLICATION_ID`          | Datadog RUM application ID for performance monitoring                                                                                                                                         |
