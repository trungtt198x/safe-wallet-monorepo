...
import { Example, ExampleWrapper } from './helpers'
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
function CardExample() {
  return (
    <Example title="Card + AlertDialog + Badge" className="items-center justify-center">
...
function FormExample() {
  ...
  return (
    <Example title="Form + DropdownMenu + Select + Combobox">
