...
import { readPkce, clearPkce } from '../../hooks/useHypernativeOAuth'
import { HYPERNATIVE_OAUTH_CONFIG, getRedirectUri } from '../../config/oauth'
...
/**
 * OAuth callback handler component for Hypernative authentication
 *
 ...
 * - This component exchanges code for token and notifies parent window
      ...
      >
        {status === 'loading' && (
          <>
            ...
            <Typography variant="body2" color="text.secondary" marginTop={1}>
              Hypernative authentication is in progress. Do not close this window.
            </Typography>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <Typography variant="body2" color="text.secondary" marginTop={1}>
              You are now signed in to Hypernative.
            </Typography>
          </>
        )}
